...
export function Menu() {
  ...
  const [currentTab, setCurrentTab] = useState<string>(tabParam ?? "svgtopng");
      ...
      <ScrollArea.Root className="w-full" type="hover">
        <ScrollArea.Viewport className="w-full overflow-x-scroll">
          <Tabs.List className="mt-6 flex w-full items-center gap-4 border-b border-zinc-800">
            <TabItem
              isSelected={currentTab === "svgtopng"}
              value="svgtopng"
              title="SVG to PNG"
            />
            <TabItem
              isSelected={currentTab === "svgtoico"}
              value="svgtoico"
              title="SVG to ICO"
            />
            <TabItem
              isSelected={currentTab === "svgtowebp"}
              value="svgtowebp"
              title="SVG to WebP"
            />
            <TabItem
              isSelected={currentTab === "svgtoreactfc"}
              value="svgtoreactfc"
              title="SVG to ReactFC"
            />
          </Tabs.List>
        </ScrollArea.Viewport>
