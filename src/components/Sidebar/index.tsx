...
export function Sidebar() {
  ...
  return (
    <Collapsible.Root
      ...
      className="scrollbar-v2 fixed left-0 right-0 top-0 z-20 flex flex-col gap-6 overflow-hidden border-b border-border bg-neutral-950 p-4 scrollbar-thin data-[state=open]:bottom-0 lg:bottom-0 lg:right-auto lg:h-auto lg:w-80 lg:overflow-auto lg:border-b-0 lg:border-r lg:px-5 lg:py-8"
    >
